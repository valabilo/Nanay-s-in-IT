...
const LearnerSidebar = ({ openCollapse, activeMainButton, setActiveMainButton, activeCollapseButton, toggleCollapse, handleMainButtonClick, handleCollapseButtonClick }) => {
    return (
        <>
            <Nav fill variant="tabs" className="mb-auto border-0 flex-column mb-0 just align-content-stretch" id="menu">
                <Nav.Item>
                    <Nav.Link href="#1" className={`d-flex gap-1 justify-content-lg-start justify-content-center border-0 align-items-center btn px-0 align-middle ${activeMainButton === 'dashboard' ? 'active' : ''}`} onClick={() => handleMainButtonClick('dashboard')}>
                        <i className="fs-5 bi bi-file-earmark-code"></i> <span className={`ms-1 d-none d-sm-inline fs-5`}>Learner</span>
                    </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                        ...
                        <ListGroup variant="flush px-3">
                            ...
                            >
                                <Button
                                    variant="flat"
                                    href="#"
                                    className={`btn text-left  ${activeCollapseButton === 'settings-3' ? 'active' : ''}`}
                ...
                <Nav.Item>
                    <Nav.Link
                        ...
                        <i className="fs-5 bi bi-gear"></i> <span className={`ms-1 d-none d-sm-inline fs-5`}>Components</span>
                    </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                    <Nav.Link
